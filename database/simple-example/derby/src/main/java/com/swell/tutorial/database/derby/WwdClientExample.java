package com.swell.tutorial.database.derby;

/*
 * WwdClientExample.java* This sample program is described in the Getting Started With Derby Manual
 * 
...
public class WwdClientExample {
  public static void main(String[] args) {
    ...
    String createString =
        "CREATE TABLE WISH_LIST  " + "(WISH_ID INT NOT NULL GENERATED ALWAYS AS IDENTITY "
    ...
    try {
      ...
      do {
        ...
        if (!answer.equals("exit")) {
          ...
          myWishes =
              s.executeQuery("select ENTRY_DATE, WISH_ITEM from WISH_LIST order by ENTRY_DATE");
      ...
      /***
       * In embedded mode, an application should shut down Derby. Shutdown throws the XJ015
